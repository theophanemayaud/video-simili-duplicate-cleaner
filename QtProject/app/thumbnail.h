...
class Thumbnail
{
  ...
  private:
    int m_mode = thumb4;
    QStringList m_modeNames = {QStringLiteral("1x1"), QStringLiteral("2x1"),    QStringLiteral("3x1"),
                               QStringLiteral("2x2"), QStringLiteral("3x2"),    QStringLiteral("3x3"),
                               QStringLiteral("4x3"), QStringLiteral("CutEnds")};
